...
from app.routers import auth, pages, clients, projects, tasks, tags, dashboard, documents, comments, backups, attachments, partner, review
...
app.include_router(partner.router, tags=["partner"])
